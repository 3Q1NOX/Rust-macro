...
namespace GladiatorMenu
{
	...
	void mainWindow()
	{
		...
		if (ImGui::Begin("memoryhackers.org | Eq1NoX | Youtube/#Eq1NoX", &menuOpen, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_ShowBorders | ImGuiWindowFlags_OnlyDragByTitleBar))
		{
			ImGui::BeginGroup();
			...
			ImGui::BeginChild("COL2", ImVec2(0, 0), true);
			{
				...
				ImGui::Columns(1, NULL, true);
				{
					...
					if (ImGui::Button("Save##Config"))
					{
						...
						{
							std::string fPath = std::string(Global::my_documents_folder) + "\\always\\" + configItems[configItemCurrent] + ".1337";
					...
					{
						std::string fPath = std::string(Global::my_documents_folder) + "\\always\\" + fName + ".1337";
						Config::Get().SaveConfig(fPath);
